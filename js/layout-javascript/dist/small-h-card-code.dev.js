...
DynamicList.prototype.attachObservers = function () {
  ...
  _this.$container.on('click', '.small-h-card-list-detail-button a', function () {
    var _that = $(this);
...
DynamicList.prototype.addSummaryData = function (records) {
  var _this = this; // Uses sumamry view settings set by users
...
DynamicList.prototype.showDetails = function (id, listData) {
  ...
  var src = this.data.advancedSettings && this.data.advancedSettings.detailHTML ? this.data.advancedSettings.detailHTML : Fliplet.Widget.Templates[_this.layoutMapping[this.data.layout]['detail']]();
  ...
  return beforeShowDetails.then(function (data) {
    ...
    $overlay.find('.small-h-card-detail-wrapper').append(template(data.data || entryData)); // Trigger animations
...
DynamicList.prototype.closeDetails = function () {
  ...
  setTimeout(function () {
    ...
    $overlay.find('.small-h-card-detail-overlay-content-holder').html(''); // This bit of code will only be useful if this component is added inside a Fliplet's Accordion component
...
DynamicList.prototype.expandElement = function (elementToExpand, id) {
  ...
  if (!elementToExpand.hasClass('open')) {
    ...
    var directoryDetailImage = elementToExpand.find('.small-h-card-list-detail-image'); // convert the expand-item to fixed position with a high z-index without moving it
...
DynamicList.prototype.collapseElement = function (elementToCollapse) {
  ...
  directoryDetailImage.animate({
    ...
    _this.closeDetails(); // This bit of code will only be useful if this component is added inside a Fliplet's Accordion component

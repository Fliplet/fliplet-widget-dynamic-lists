var feedCommentsLayoutMapping = {
  'feed-comments': {
    ...
    'comments': 'templates.build.feed-comments-comment',
    'single-comment': 'templates.build.feed-comments-single-comment',
    'temp-comment': 'templates.build.feed-comments-temp-comment'
  }
};
...
DynamicList.prototype.renderBaseHTML = function() {
  ...
  if (typeof _this.data.layout !== 'undefined') {
    baseHTML = Fliplet.Widget.Templates[feedCommentsLayoutMapping[_this.data.layout]['base']];
  }
...
DynamicList.prototype.renderLoopHTML = function(records) {
  ...
  : Handlebars.compile(Fliplet.Widget.Templates[feedCommentsLayoutMapping[_this.data.layout]['loop']]());
...
DynamicList.prototype.addFilters = function(data) {
  ...
  filtersTemplate = Fliplet.Widget.Templates[feedCommentsLayoutMapping[_this.data.layout]['filter']];
...
DynamicList.prototype.showComments = function(id) {
  ...
  _this.connectToCommentsDataSource(id).then(function() {
    ...
    var commentsTemplate = Fliplet.Widget.Templates[feedCommentsLayoutMapping[_this.data.layout]['comments']];
...
DynamicList.prototype.appendTempComment = function(id, value, guid) {
  ...
  var tempCommentTemplate = Fliplet.Widget.Templates[feedCommentsLayoutMapping[_this.data.layout]['temp-comment']];
...
DynamicList.prototype.replaceComment = function(guid, commentData, context) {
  ...
  if (context === 'temp') {
    var commentTemplate = Fliplet.Widget.Templates[feedCommentsLayoutMapping[_this.data.layout]['temp-comment']];
    var commentTemplateCompiled = Handlebars.compile(commentTemplate());
    var commentHTML = commentTemplateCompiled(commentInfo);
  }

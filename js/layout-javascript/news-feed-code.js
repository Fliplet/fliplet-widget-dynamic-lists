...
DynamicList.prototype.addDetailViewData = function(entry, files) {
  ...
  if (_this.data.detailViewAutoUpdate) {
    ...
    // (detail-fields-disabled -- this is that layout, news-feed), skip the exclusion
    // while it is still empty -- otherwise it can never populate once a snapshot
    // exists. See interface.js.

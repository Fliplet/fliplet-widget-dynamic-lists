...
window.flListLayoutTableConfig = {
  ...
  'news-feed': [
    ...
    },
    {
      ...
      'Categories': 'Apps',
      'Date': moment().subtract(1, 'months').subtract(3, 'days').format('YYYY-MM-DD'),
  ...
  'agenda': [
    {
      ...
      'Full Date': moment().add(3, 'weeks').format('YYYY-MM-DD'),
      'Start Time': '09:00',
      'End Time': '09:45',
    ...
    },
    {
      ...
      'Full Date': moment().add(3, 'weeks').add(1, 'day').format('YYYY-MM-DD'),
      'Start Time': '09:00',
      'End Time': '09:45',
      'Location': 'Hotel\'s Restaurant',

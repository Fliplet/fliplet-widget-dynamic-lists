...
this["Fliplet"]["Widget"]["Templates"]["templates.interface.filter-panels"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"panel panel-default filter-panel\" data-id=\""
    ...
    + "\" id=\"value-type-field-"
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "\" data-field=\"valueType\" data-label=\"-- Enter a value\" class=\"hidden-select form-control\">\n              <option value=\"enter-value\">Entry a value</option>\n              <option value=\"user-data\">User profile data</option>\n              <option value=\"storage-variable\">App storage variable</option>\n              <option value=\"link-query\">Link query parameter</option>\n            </select>\n            <span class=\"icon fa fa-chevron-down\"></span>\n            <span class=\"select-value-proxy\">-- Please wait</span>\n          </label>\n        </div>\n      </div>\n\n      <div class=\"form-group clearfix\" id=\"filter-value\">\n        <div class=\"col-sm-4 control-label\">\n          <label for=\"value-field-"
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
